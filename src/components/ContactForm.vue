<template>
    <Form @submit="submitContact" :validation-schema="contactFormSchema">
        ...
        <div class="form-group ">
            <button class="btn btn-primary m-1">Lưu</button>
            <button v-if="contactLocal._id" type="button" class="ml-2 btn btn-danger m-1" @click="deleteContact">
                Xóa
            </button>
            <button type="button" class="ml-2 btn btn-danger m-1" @click="Cancel">
                Thoát
            </button>
        </div>
    </Form>
